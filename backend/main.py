...
from pubsub.manager import INSTANCE_ID, PubSubManager
...
async def websocket_endpoint(websocket: WebSocket, room_id: str):
    ...
    # 3. Notifica gli altri client (anche sulle altre istanze) che è arrivato un giocatore
    ...
    try:
        ...
        # Pubblica evento di uscita sulle altre istanze
