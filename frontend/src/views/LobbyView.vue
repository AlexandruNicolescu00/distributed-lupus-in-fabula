...
// Adatta player al formato player_id/username usato da PlayerCard
      ...
      <div class="main-layout">
        ...
        <section class="cards-area">
          <div class="cards-title">
            ...
            <span class="cards-count">
              {{ lobbyStore.players.length }} / {{ MAX_PLAYERS }}
            </span>
          </div>

          <div class="cards-grid">
            <!-- PlayerCard per ogni giocatore connesso -->
            <PlayerCard
        ...
        <aside class="side-panel">
          ...
          <div class="info-box">
            ...
            <div class="info-row">
              <span>Min giocatori</span><strong>{{ MIN_PLAYERS }}</strong>
            </div>
            <div class="info-row">
              <span>Max giocatori</span><strong>{{ MAX_PLAYERS }}</strong>
            </div>
            <div class="info-row">
              <span>Pronti</span>
          ...
          <button
            ...
            :disabled="
              !lobbyStore.allReady ||
              lobbyStore.players.length < MIN_PLAYERS
            "
            @click="handleStart"
          >
          ...
          >
            {{ lobbyStore.currentPlayer?.ready
              ? '✓ Pronto — annulla'
              : 'Sono pronto!' }}
          </button>
          ...
          <button class="btn-leave" @click="leaveLobby">
            Abbandona lobby
          </button>
        </aside>
      </div>
...
.cards-title {
  ...
  text-transform: uppercase; color: rgba(232,200,122,0.45);
  margin-bottom: 1rem;
...
/* ---- BUTTONS ---- */
.btn-main, .btn-ready, .btn-leave {
  width: 100%; padding: 0.8rem 1rem; border-radius: 10px; border: none;
